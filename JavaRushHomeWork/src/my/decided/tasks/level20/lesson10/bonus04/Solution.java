package my.decided.tasks.level20.lesson10.bonus04;
...
public class Solution extends AbstractList<String> implements List<String>, Cloneable, Serializable
{
    ...
    public static void main (String[]args)throws IOException, ClassNotFoundException, CloneNotSupportedException
    {
        ...
        List<String> list1 = new Solution();
        list1.add("1231331");
        list1.add(":-) 1");
        ...
        System.out.println(("должно быть :-) 3, а по факту " + ((Solution) list).getParent(":-) 7")));
        System.out.println(("должно быть :-) 3, а по факту " + ((Solution) list).getParent(":-) 8")));
        System.out.println(("должно быть :-) 4, а по факту " + ((Solution) list).getParent(":-) 9")));
        System.out.println(("должно быть :-) 4, а по факту " + ((Solution) list).getParent(":-) 10")));
        System.out.println(("должно быть :-) 1, а по факту " + ((Solution) list).getParent(":-) 3")));
        System.out.println(("должно быть :-) 1, а по факту " + ((Solution) list).getParent(":-) 4")));
        System.out.println(("должно быть null, а по факту " + ((Solution) list).getParent(":-) 1")));
        for (Object o:list1){
            System.out.println(o + "parent - " + ((Solution) list).getParent((String) o));
        }
    ...
    {
        Solution res = (Solution) super.clone();
        res.clear();
    ...
    public String[] toArray()
    {
        ...
        IteratorSolution it = new IteratorSolution();
        int i = 0;
        while (it.hasNext())
        {
            res[i] = it.next();
