package my.decided.tasks.level35.lesson10.bonus01;
...
public class Solution {
    ...
    public static Set<? extends Animal> getAllAnimals(String pathToAnimals) {
        ...
        for(String currentClassName : classes) {
            try {
                ...
                String mName = currentClassName.substring(0, currentClassName.length() - 6);
