package my.decided.tasks.level30.lesson02.home01;
...
public class Solution {
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        ...
        Number number1 = new Number(expectedNumerationSystem, num.toString(expectedNumerationSystem.getNumerationSystemIntValue()));
        return number1;
    }
}
